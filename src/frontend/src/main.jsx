...
function App() {
  ...
  async function refreshWorkspace() {
    ...
    setNotice('');
    try {
      const [decisionsData, reviewData, dqsData, behaviorData, strategyData, profileData, portfolioData] = await Promise.all([
        api('/api/decisions/open'),
        api('/api/reviews'),
      ...
      <DecisionCaptureModal
        ...
        onSubmit={async (decision, isAutoDecision) => {
          ...
          try {
            ...
            // Route to unified decision endpoint
            const endpoint = '/api/decisions/investment';
