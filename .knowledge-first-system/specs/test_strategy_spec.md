...
- What runs on **every commit**, **every PR**, and **main/nightly** (align with `cicd_spec.md`).
- Flake and quarantine policy.

### 2.5 Regression

- What counts as the **regression** suite for your product.
- How **legacy** or **slice** work adds **characterization** tests before refactors (see use guide, Scenario 3).
...
| 1.2 | 2026-05-06 | approved | — | KFS docs moved to repo-root **`.knowledge-first-system/`**; spec files renamed (dropped `knowledge_first_system_` prefix). |
