...
| File | Purpose |
| --- | --- |
| `.knowledge-first-system/specs/prd_spec.md` | This file — **how** to write PRDs. |
| `docs/prd/<area>_<name>_prd.md` | **Individual** PRD documents (conventional path). |

**This knowledge-first-system package** may ship **without** a `docs/` tree. When you add PRDs in-repo, **create `docs/prd/`** first (**`.knowledge-first-system/README.md`**).
...
Workflows: `.knowledge-first-system/skills/merge-knowledge-first/SKILL.md` · `.knowledge-first-system/skills/validate-knowledge-graph/SKILL.md`
...
| Revision | Date | Status | Supersedes | Notes |
| --- | --- | --- | --- | --- |
| 1.0 |  | approved | — | Initial spec under `.knowledge-first-system/` |
