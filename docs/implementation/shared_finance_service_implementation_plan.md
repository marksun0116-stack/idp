...
| US-132 | Phase I | idp, finance-data-service, stock-monitor | Run end-to-end smoke with all services and verify IDP strategy quotes and stock-monitor watchlist quotes. | in_progress | US-119, US-121, US-124 | No | CONR-finance-service-api-001 | In progress | Requires finance service, IDP, stock-monitor, and DBs running. Testing all /api/finance/* endpoints and consumer integrations. |
