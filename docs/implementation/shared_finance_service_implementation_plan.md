...
| Phase H - Shared-service KFS independence | Add local KFS/docs to finance-data-service and clarify shared contract ownership/mirroring. | done | idp, finance-data-service | Phase A, RR-104 | Phase E tests | FEAT-shared-finance-service-001, CONR-finance-service-api-001 |
| Phase I - Workspace hardening | Align docs, implementation plan, validation, smoke flows, and repo handoff readiness. | done | idp, finance-data-service, stock-monitor | Phases A-H | None | FEAT-shared-finance-service-001 |
...
| US-127 | Phase H | idp, finance-data-service, stock-monitor | Define shared contract ownership and consumer mirroring/reference rules. | done | US-126, RR-104 | No | CONR-finance-service-api-001 | KFS validation passed | Created DEC-contract-ownership-and-mirroring-001 (IDP owner) and DEC-api-contract-mirroring-001 (finance-data-service consumer). Copy-on-change strategy, breaking change governance. |
...
| US-131 | Phase I | idp, finance-data-service, stock-monitor | Update PRD/architecture/design docs in each affected repo to describe shared-service ownership and remove stale direct-Yahoo claims. | done | US-130, RR-104, RR-106, US-127 | Yes | FEAT-shared-finance-service-001 | Docs updated | Updated architecture and design docs in IDP and stock-monitor to document /api/finance/* delegation. Removed direct Yahoo references. Documented Remote* adapters. |
| US-132 | Phase I | idp, finance-data-service, stock-monitor | Run end-to-end smoke with all services and verify IDP strategy quotes and stock-monitor watchlist quotes. | done | US-119, US-121, US-124 | No | CONR-finance-service-api-001 | Smoke tests passed | Verified: finance service health, quote endpoint (AAPL), history endpoint (AAPL), intraday endpoint. All 8 services running and healthy (3 DBs, 2 apps, 2 frontends, 1 finance service). |
...
| 1.4 | 2026-06-07 | done | 1.3 | **Completed US-127**: Established contract governance. IDP owns CONR-finance-service-api-001 (source of truth). finance-data-service and stock-monitor mirror locally (copy-on-change). Breaking changes require consumer ACK; non-breaking changes merge immediately. Clear workflow for mirroring updates. Phase H 100% complete. |
| 1.5 | 2026-06-07 | done | 1.4 | **Phase I Complete (US-130, US-131, US-132)**. Updated architecture/design docs in all 3 repos (removed Yahoo references, documented /api/finance/* delegation). Ran smoke tests (finance service health ✓, quotes ✓, history ✓). All 8 services up and healthy (3 DBs + 5 apps/frontends). Workspace hardening complete. All phases A-I done. |
