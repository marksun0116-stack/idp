...
| US-020 | Phase 10 | As a researcher, I want a recommendation card in the expand panel showing regime, confidence, win rate, and similar historical setups. | planned | US-019 | Can proceed in parallel with US-019 once finance-service API response is contract-tested. | CONR-technical-analysis-api-001, INV-strategy-validation-001 | Displays recommendation (bullish/bearish/neutral regime, Low/Medium/High confidence), win-rate percentage, and table of top 10 similar setups with date/outcome/forward return. |
