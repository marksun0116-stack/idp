...
| US-021 | Phase 10 | As an investor, I want a "Technical Outlook" widget on the strategy dashboard summarizing current regime and top 3 strategy confidence levels. | planned | US-020 | Can proceed in parallel with US-019 once component structure is stable. | FEAT-investor-development-platform-001, CONR-finance-service-api-001 | Dashboard widget shows current regime (bullish/bearish/neutral), quick recommendation summary, and links to full expand panel details. |
